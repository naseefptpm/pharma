    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li>  <a href="{{ route('admin.log') }}">Logout</a> </li>
...
@endif
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Employee Details</p>
                  <form style="margin-left:700px;" action="{{ url('/search')}}" class="form-inline my-2 my-lg-0" type="get">
                    <input type="search" class="form-control rounded" name="query" placeholder="search Employees" aria-label="Search">
                      ...
                      <tbody>
                        ...
                        <tr>
                         <td>{{$i++}}</td>
                          ...
                          <td>{{$employee->week}}</td>
                          <td>{{$employee->work}}</td>
						  <td><a href="{{url('/'.$employee->attach)}}">View</a></td>

                          <td> <a href="{{url('employee/edit/'.$employee->id)}}" class="btn btn-info">Update</a>  </td>
                          <td> <a href="{{url('delete/employee/'.$employee->id)}}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger">Delete</a> </td>                        </tr>
