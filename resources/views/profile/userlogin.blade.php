...
<body class="hold-transition theme-primary bg-gradient-primary">
                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="content-top-agile p-10">
                            <h2 class="text-white">Employee Login</h2>
  ...
  <input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
    ...
    <div class="text-center text-white">
      <a href="{{ route('admin.log') }}"><button type="submit" class="btn btn-info btn-rounded mt-10">LOGIN as Admin</button></a>
     
    </div>
    
    <div class="text-center">
        <p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{ route('register') }}" >Register</a></p>
                            </div>
                        </div>
                    </div>
                </div>
